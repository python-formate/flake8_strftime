...
description_block = """A flake8 plugin which checks for use of platform specific strftime codes.
...
about:
  home: "https://github.com/domdfcoding/flake8_strftime"
  license: "MIT License"
  # license_family: LGPL
  # license_file: LICENSE
  summary: "A flake8 plugin which checks for use of platform specific strftime codes."
  description: "{description_block}"
  doc_url: https://flake8_strftime.readthedocs.io
  dev_url: https://github.com/domdfcoding/flake8_strftime
